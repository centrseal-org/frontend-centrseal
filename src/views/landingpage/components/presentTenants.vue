...
const presentTenants = [
  {
    title: "Spend 0 minutes sending repeat questions to leads",
  ...
  {
    title: "1 in 4 submitted documents are fake",
...
<template>
  <div class="bg-secondary">
    <h2 class="text-center">Present Tenants with Confidence</h2>
    <v-container>
      <v-row>
          ...
          <v-card>
            <v-card-item>
              <v-card-title class="text-wrap">
                {{ presentTenant.title }}</v-card-title
              >
            </v-card-item>
            <v-card-text>
              {{ presentTenant.text }}
